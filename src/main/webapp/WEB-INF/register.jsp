    ...
    <div class="container">
        ...
        <form action="/register" method="post">
            <div class="form-group">
                ...
                <input id="username" name="username" class="form-control" type="text" value="${sessionScope.username}" required>
                <p>(Cannot contain ('<','>','(',')')</p>
            </div>
            <div class="form-group">
                <label for="email">Email</label>
                <input id="email" name="email" class="form-control" type="text" value="${sessionScope.email}" required>
            </div>
            <div class="form-group">
